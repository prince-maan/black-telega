...
@app_flask.route('/')
def home(): return "Friend Bot is active!"
def run_flask(): app_flask.run(host='0.0.0.0', port=int(os.environ.get("PORT", 8080)))
Thread(target=run_flask).start()

# --- 2. SETTINGS (FRIEND) ---
TOKEN = '8783186988:AAFYb8O2uV-kjmC9HYmSuM6b5ZV19y3FUCY' 
...
USER_COLLECTION = db["Friend_Users"] # दोस्त के मेंबर्स इस फोल्डर में सेव होंगे
FILE_COLLECTION = db["common_files"] # फाइल्स दोनों बॉट की सेम रहेंगी
CODE_COLLECTION = db["Friend_Codes"] # प्रोमो कोड्स अलग रहेंगे
...
print("Friend Cloud Bot Started! 🔥")
app.run_polling()